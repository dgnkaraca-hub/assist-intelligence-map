...
export const consoleData: ConsoleData = {
  ...
  nodes: [
    ...
    },
    {
      ...
      details: [
        "Waiting: festival / event invitation to answer",
        "Universe sends land here (Send to Assist)",
        "Replies drafted for one-tap send",
        "Flagged and archived items",
      ],
      metrics: [
        { label: "To answer", value: "1" },
        { label: "Routed", value: "0" },
        { label: "Flagged", value: "1" },
      ],
      relatedNodes: ["tasks", "research", "agents"],
      links: [{ label: "Open Inbox", url: "#" }],
      nextActions: ["Answer the festival invitation", "Route new sends from the Universe", "Archive the resolved"],
