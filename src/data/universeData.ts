...
export interface ChildNode {
  ...
  relatedIds?: string[];
  /** Long-form editorial reading (richer than `extended`). */
  longForm?: string;
  /** Priority signal surfaced by the Assist layer. */
  priority?: "low" | "medium" | "high";
  /** Evidence backing this node's claims (artifacts, citations, files). */
  evidence?: string[];
  /** Ids of Assist-layer projects this node feeds. */
  relatedProjects?: string[];
  /** Repository or folder this work lives in. */
  sourceRepo?: string;
  /** Deep-link route inside the merged app (e.g. "#/universe/node/<id>"). */
  route?: string;
}
...
export const mapData: MapData = {
  ...
  domains: [
    ...
    },
    {
      ...
      children: [
        {
          id: "anatolian-crossroads",
          label: "Anatolian Crossroads",
          type: "project",
          tip: "A memory graph from Neolithic symbols to Iron Age inscriptions.",
          desc: "A digital humanities memory graph mapping selected Anatolian sites, concepts, symbols, inscriptions, and interpretive corridors from the Neolithic to the Iron Age (9600–700 BCE). Published with a DOI and a live atlas.",
          extended:
            "The macro graph joins 10 sites through geographic corridors and explicit comparative pairs only — no direct cultural continuity is claimed; the schema itself rejects continuity edges. All thematic meaning flows through 9 shared concepts (ritual, body, animal symbolism, writing, power, trade, memory, multilingualism, border kingdoms). Three completed micro modules — Sam'al, Göbekli Tepe, and Kültepe-Kaneš — plug in through a curated, sourced bridge layer, and the combined network ships as open data (GEXF).",
          tags: ["digital humanities", "memory graph", "open data", "DOI"],
          links: [
            { label: "Live atlas", url: "https://dgnkaraca-hub.github.io/anatolian-crossroads/" },
            { label: "GitHub repository", url: "https://github.com/dgnkaraca-hub/anatolian-crossroads" },
            { label: "DOI · Zenodo", url: "https://doi.org/10.5281/zenodo.21158715" },
          ],
          status: "featured",
          year: "2026",
          role: "Author · design, data model, and build",
          confidence: "confirmed",
          source: {
            kind: "project-import",
            label: "anatolian-crossroads repository",
            url: "https://github.com/dgnkaraca-hub/anatolian-crossroads",
            note: "Figures read from the public README and dataset.",
          },
          metrics: [
            { label: "Sites", value: "10" },
            { label: "Shared concepts", value: "9" },
            { label: "Time range", value: "9600–700 BCE" },
            { label: "Micro modules", value: "3" },
          ],
          relatedIds: ["samal-network", "gobekli-network", "kultepe-network"],
          sourceRepo: "https://github.com/dgnkaraca-hub/anatolian-crossroads",
        },
        {
          id: "samal-network",
          label: "Sam'al Epigraphic Network",
          type: "research",
          tip: "The Aramean dynasty of Zincirli as a sourced graph — completed.",
          desc: "A network visualization of epigraphic relationships, built with Vite, React, TypeScript, and D3, modelling inscriptions as a connected graph. Completed, and now a micro module of Anatolian Crossroads.",
          extended:
            "The build models the Aramean dynasty of Zincirli (c. 920–713 BCE) as a sourced graph — kings, officials, inscriptions, languages, and deities — with a timeline view beside the relational network. Every entity and relation carries an explicit citation and a confidence rating; scholarly disagreements are recorded in the notes rather than hidden.",
          tags: ["D3", "TypeScript", "epigraphy"],
          status: "archive",
          year: "2026",
          confidence: "confirmed",
          source: {
            kind: "project-import",
            label: "Anatolian Crossroads — Sam'al module",
            url: "https://dgnkaraca-hub.github.io/anatolian-crossroads/samal/",
          },
          links: [
            { label: "Live module", url: "https://dgnkaraca-hub.github.io/anatolian-crossroads/samal/" },
          ],
          metrics: [
          ...
          relatedIds: ["anatolian-crossroads"],
        },
        {
          id: "gobekli-network",
          label: "Göbekli Tepe Iconography",
          type: "research",
          tip: "Pillar iconography as a connected graph — completed.",
          desc: "A research build mapping iconographic motifs as a connected graph, exploring how symbols cluster and relate. Completed, and now a micro module of Anatolian Crossroads.",
          extended:
          ...
          tags: ["network", "iconography"],
          status: "archive",
          year: "2026",
          confidence: "confirmed",
          source: {
            kind: "project-import",
            label: "Anatolian Crossroads — Göbekli Tepe module",
            url: "https://dgnkaraca-hub.github.io/anatolian-crossroads/gobeklitepe/",
          },
          links: [
            { label: "Live module", url: "https://dgnkaraca-hub.github.io/anatolian-crossroads/gobeklitepe/" },
          ],
          metrics: [
        ...
        {
          id: "kultepe-network",
          label: "Kültepe-Kaneš Network",
          type: "research",
          tip: "The Pūšu-kēn family network from Old Assyrian Kültepe — completed.",
          desc: "A network build around the Pūšu-kēn merchant family of Old Assyrian Kültepe-Kaneš, modelling the trade archive as a relational graph. Completed, and now a micro module of Anatolian Crossroads.",
          tags: ["network", "Old Assyrian", "trade"],
          status: "archive",
          year: "2026",
          confidence: "confirmed",
          source: {
            kind: "project-import",
            label: "Anatolian Crossroads — Kültepe module",
            url: "https://dgnkaraca-hub.github.io/anatolian-crossroads/kultepe/",
          },
          links: [
            { label: "Live module", url: "https://dgnkaraca-hub.github.io/anatolian-crossroads/kultepe/" },
          ],
          relatedIds: ["anatolian-crossroads"],
        },
        {
  ...
  relations: [
    ...
    { from: "anatolian-crossroads", to: "samal-network", type: "research", label: "Micro module of the macro memory graph" },
    { from: "anatolian-crossroads", to: "gobekli-network", type: "research", label: "Micro module of the macro memory graph" },
    { from: "anatolian-crossroads", to: "kultepe-network", type: "research", label: "Micro module of the macro memory graph" },
    { from: "network-analysis", to: "kultepe-network", type: "method", label: "Graph methods power the trade-archive network" },
  ...
  selectedWorks: [
    {
      ...
      meta: "Digital Humanities · 2026 · DOI",
      url: "https://dgnkaraca-hub.github.io/anatolian-crossroads/",
      desc: "A memory graph from Neolithic symbols to Iron Age inscriptions — 10 sites, 9 shared concepts, three sourced micro modules, published as open data.",
    },
    {
